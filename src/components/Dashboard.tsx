                        ...
                        <div className="card-body p-4 d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <h4 className="fw-bolder mb-0" style={{ color: '#2b3674' }}>
                              {Number(stats.total_session).toLocaleString('fr-FR')} <span className="fs-6 text-muted">FCFA</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '20px' }}>
                        <div className="card-body p-4 d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <h4 className="fw-bolder mb-0" style={{ color: '#2b3674' }}>
                              {Number(stats.total_depenses).toLocaleString()} <span className="fs-6 text-muted">FCFA</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="card-body p-4 d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <h4 className={`fw-bolder mb-0 ${stats.montant_net_session >= 0 ? 'text-success' : 'text-danger'}`}>
                              {stats.montant_net_session > 0 ? '+' : ''}{Number(stats.montant_net_session).toLocaleString()} <span className="fs-6 text-muted">FCFA</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="card border-0 shadow-sm h-100" style={{ borderRadius: '20px' }}>
                        <div className="card-body p-4 d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <h4 className="fw-bolder mb-0" style={{ color: '#2b3674' }}>
                              {Number(stats.total_mois).toLocaleString()} <span className="fs-6 text-muted">FCFA</span>
                            </h4>
                          </div>
                        </div>
                      </div>
